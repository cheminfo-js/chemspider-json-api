(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["chemspiderJsonApi"] = factory();
	else
		root["chemspiderJsonApi"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports = module.exports = {
	    query: function query(operation, options) {
	        if (!operation) throw new Error('Operation paramater is mandatory');
	        options = Object.assign({}, options);
	        var queryUrl = constructUrl(operation, options);
	        return superagent.get(queryUrl).then(function (res) {
	            return res.text;
	        });
	    },

	    queryWithRid: function queryWithRid(operation, options) {
	        var interval = 100;
	        var rep = 0;
	        var maxRep = 10;
	        ...
	        function handleError(err) {
	            ...
	            return wait(interval).then(function () {
	                return exports.queryJSON(operation, options);
	            }).then(null, handleError);
	        }
	    },

	    queryJSON: function queryJSON(operation, options) {
	        return exports.query(operation, options).then(function (text) {
	    ...
	    search: function search(options) {
	        ...
	        return exports.query(searchMethod, searchOptions).then(function (rid) {
...
/***/ function(module, exports) {
	...
	exports.searchMethods = ['SimpleSearch', 'ExactStructureSearch', 'SubstructureSearch', 'SimilaritySearch', 'IntrinsicPropertiesSearch', 'DataSourceSearch', 'ElementsSearch', 'PredictedPropertiesSearch', 'AdvancedSearch'];

	exports.resultMethods = ['GetSearchResult', 'GetSearchResultWithRelevance', 'GetSearchResultAsCompounds', 'GetSearchResultAsSdf'];
	exports.chemspiderUrl = 'https://www.cheminfo.org/chemspider/JSON.ashx';
