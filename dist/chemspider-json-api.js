...
exports = module.exports = {
    query: function query(operation, options) {
        ...
        return superagent.get(queryUrl).timeout({ response: 20000 }).then(res => res.text);
    },
    ...
    queryWithRid: function queryWithRid(operation, options) {
        ...
        function handleError(err) {
            ...
            return wait(interval).then(() => exports.queryJSON(operation, options)).then(null, handleError);
        }
    },
